...
res<-fwdControl(data.frame(year=1990:1991,quantity="f"),trgtArray=x)
...
x  <-list(val=array(11:20,c(1,10),dimnames=list(1,1:10)))
res<-fwdControl(data.frame(year=1990,quantity="f"),trgtArray=x,effort=data.frame(year=1990),effArray=x)
