...
invisible(createFLAccesors("FLBioDym", exclude=c("range","name","desc","index.hat","distribution","hessian","LL","rsdlVar","dof","stats","stopmess"))) #,"params","hessian","LL")))
