...
#### Fletcher
plot( sp("fletcher", bio,K=K,msy=r.*K/4,p=2)~bio, type="l",xlab="Biomass",ylab="Surplus Production",main="Fletcher")
bullseye("fletcher",K=K,msy=r.*K/4,p=2)
...
#### Fletcher
f    <-function (x,K,msy,p=2) sp("fletcher", x,K=K,msy=r.*K/4,p=2)
tst  <-optimize(f, c(0, K), tol = 0.0001, maximum=TRUE, K=K,msy=r.*K/4,p=2)
tst$objective- msy("fletcher",K=K,msy=r.*K/4,p=2)
