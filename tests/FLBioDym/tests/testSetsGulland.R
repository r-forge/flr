...
rocklobBD <-fit(rocklobBD, fixed=lobPar[c("r","K")], model="gulland")
namhkeBD <-fit(namhkeBD, fixed=hkePar[c("r","K")], model="gulland")
albBD2<-fit(albBD, start=albPar[c("r","K")], model="gulland")
rocklobBD2<-fit(rocklobBD, start=lobPar[c("r","K")], model="gulland")
namhkeBD2<-fit(namhkeBD, start=hkePar[c("r","K")], model="gulland")
