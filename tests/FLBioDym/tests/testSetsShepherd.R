...
rocklobBD <-fit(rocklobBD, fixed=lobPar[c("r","K")], model="shepherd")
namhkeBD <-fit(namhkeBD, fixed=hkePar[c("r","K")], model="shepherd")
albBD2<-fit(albBD, start=c("r"=0.25,"K"= 20000), fixed=(m=.25),model="shepherd")
rocklobBD2<-fit(rocklobBD, start=c("r"=0.75,"K"=100000), fixed=c(m=.25),model="shepherd")
namhkeBD2<-fit(namhkeBD, start=c("r"=0.25,"K"= 20000), fixed=c(m=.25),model="shepherd")
