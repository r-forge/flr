...
albBD <-fit(albBD, fixed=albPar[c("r","K")])
rocklobBD <-fit(rocklobBD, fixed=lobPar[c("r","K")])
namhkeBD <-fit(namhkeBD, fixed=hkePar[c("r","K")])
albBD2<-fit(albBD, start=albPar[c("r","K")])
rocklobBD2<-fit(rocklobBD, start=lobPar[c("r","K")])
namhkeBD2<-fit(namhkeBD, start=hkePar[c("r","K")])
