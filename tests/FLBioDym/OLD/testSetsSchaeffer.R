...
albBD <-fit(albBD, fixed=albPar[c("r","K")], model="schaefer")
rocklobBD <-fit(rocklobBD, fixed=lobPar[c("r","K")], model="schaefer")
namhkeBD <-fit(namhkeBD, fixed=hkePar[c("r","K")], model="schaefer")
albBD2<-fit(albBD, start=albPar[c("r","K")], model="schaefer")
rocklobBD2<-fit(rocklobBD, start=lobPar[c("r","K")], model="schaefer")
namhkeBD2<-fit(namhkeBD, start=hkePar[c("r","K")], model="schaefer")
