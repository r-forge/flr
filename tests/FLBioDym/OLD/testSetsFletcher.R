...
rocklobBD <-fit(rocklobBD, fixed=lobPar[c("K","msy")], model="fletcher")
namhkeBD <-fit(namhkeBD, fixed=hkePar[c("K","msy")], model="fletcher")
albBD2<-fit(albBD, start=albPar[c("K","msy")], model="fletcher")
rocklobBD2<-fit(rocklobBD, star=lobPar[c("K","msy")], model="fletcher")
namhkeBD2<-fit(namhkeBD, start=hkePar[c("K","msy")], model="fletcher")
