...
# catch.sel, catch.obs, biomass.obs, yield.obs {{{
...
setMethod('computeFbar', signature(object='FLBRP'),
  function(object)
    return(apply(harvest(object)[ac(object@range["minfbar"]:object@range["maxfbar"])],
        c(2:6),mean))) # }}}
