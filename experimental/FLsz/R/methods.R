pathNm="/home/lkell/flr/experimental/FLln2z/inst/admb"
...
setMethod('seine', signature(object='FLln2z'),
...
setMethod("breaks<-", signature(object="FLln2z", value="numeric"),
...
setMethod("ln2z", signature(object="FLln2z"),
  function(object) ln2z(object@obs,object@grw))
