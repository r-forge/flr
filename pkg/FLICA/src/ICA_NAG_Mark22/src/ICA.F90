...
!      goto 100
      call ICA1
!DEBUG      write(*,*) 'CAll to ICA1 finished OK'
      call ICA2(X,VCV)
...
!DEBUG      write(*,*) 'CAll to LSFUN1'   
      CALL LSFUN1(Nxdata,NxParm, Xbest, Resids)                                                                                     
!DEBUG      write(*,*) 'CAll to LSFUN1 OK' 
      SSQ=0d0
      do i=1,Nxdata                                                                                                                 
...
!      double precision G05DDF
      ...
      integer tscan, ISEED(4), IGEN, MODE
...
!
      ...
      !! WITHDRAWN AT Mark 22 call G05EAF(X, NxParm, VCV, IC, EPS, R, NR, IFail)
...
!      endif
      ...
      do ITS = 1, ItsToRun
!        write(*,*) Its
!! WITHDRAWN AT Mark 22        Call G05EZF(Z,NxParm, R, NR, Ifail)
      call G05LZF(MODE, NxParm, X, VCV, IC, Z, IGEN, ISEED, R, NR, IFail)
        if (Ifail .ne. 0) then
          write(Text(1), '(I2)') IFAIL
