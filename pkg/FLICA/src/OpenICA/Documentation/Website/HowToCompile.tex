         ...
         \begin{itemize}
           ...
           A \htmladdnormallink{makefile}{./src/makefile} is provided to compile OpenICAMINUIT. Editing this file might be required to customize the PATH of the library to your particular system. 
