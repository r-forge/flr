         To compile this version of OpenICA, it is necessary to install the \htmladdnormallink{CERN}{http://www.cern.ch/cernlib} program library.

         \begin{itemize}

           \item On Linux, 

           OpenICA was compiled using the \htmladdnormallink{Intel fortran compiler}{http://www.intel.com/software/products/compilers/flin/}. Instructions to install this compiler on Ubuntu are \htmladdnormallink{available}{http://ubuntuforums.org/showthread.php?t=179589}. The command to install cernlib on Ubuntu is: \begin{verbatim} sudo apt-get install cernlib \end{verbatim}

           A \htmladdnormallink{makefile}{./source/makefile} is provided to compile OpenICA. Editing this file might be required to customize the PATH of the library to your particular system. 
