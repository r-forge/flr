...
\section{License} \input{license.tex}

\section{Quality control}

   \subsection{Fortran code} The fortran code was checked for errors using \htmladdnormallink{ftnchk}{http://www.dsm.fordham.edu/~ftnchek/}.

   \subsection{Testing the algorithm} \input{test.tex}

\section{Download} \input{./Download.tex}

\section{Known problems}
	\subsection{with Unix/Linux} \input{unixTroubleShooting.tex}

\section{Tips}

         \subsection{Unix/Linux tips} \input{unixtips.tex}
