...
!                  Version 1.4x date October 2010                                                                                   !
!       Modified by M. Kienzle (marco.kienzle@gmail.com)
! /////////////////////// MODIFICATIONS /////////////////////////////////                                                           
...
!          parameters are read from a file ICA.TMP which is wrtten by ICA1.                                                        
!                                                                                                                                   
...
write(*,*) 'in ICA2_90.F90 nodats is', nodats
write(*,*) 'in ICA2_90.F90 noparms is', noparms
...
!          Call LSFUN1(nodats, Noparms, Params, Resids)                                                                                        Call LSFUN1(Noparms, nodats, Resids, Params)                                                                              
        enddo                                                                                                                       
...
! !       cj, wk2, ifaily)                                                                                                          !!!!! ATTEMPT TO USE MINUIT
