...
# PURPOSE: compare parameter estimates from OpenICA (ICA version 1.4 x) to simulated data
# DATE: 1 June 2005
...
if($help){print "OPTION: this program need the path of the directory containing the data files\n";
	  ...
	  print "v: the version of ICA used\n";
          print "USAGE:  -d=Absolute-NoVariability-NoSSBbias-NoCatchBias-SSBsurveyNVNVNV -v=OpenICA\n";
          exit();}
