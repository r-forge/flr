######## Plot stuff #############################################################################################
theme_flr = function (base_size=16,font=NA,face='plain', 
	                    backgroundColor='white',   panelColor=backgroundColor, 
                      axisColor      ='#999999', gridColor=backgroundColor, textColor='black',
                      axis.text=1.0, angle.x=0, angle.y=-90,
                     ...) {
      ...
      (res=opts(panel.grid.major = theme_blank(),
                           ...
                           axis.text.x       = theme_text(angle=angle.x, hjust=1, vjust=0.5,   colour=axisColor, family=font, face=face, size=base_size*axis.text),
                           axis.text.y       = theme_text(angle=angle.y, hjust=1, vjust=0.5,   colour=axisColor, family=font, face=face, size=base_size*axis.text),
                           axis.title.x      = theme_text(angle= 0,        colour=textColor, family=font, face=face, size=base_size),
