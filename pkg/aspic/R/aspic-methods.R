if (!isGeneric("cpue<-"))   setGeneric("cpue<-",    function(object,value,...) standardGeneric('cpue<-'))
if (!isGeneric("params<-")) setGeneric("params<-",  function(object,value,...) standardGeneric('params<-'))

if (!isGeneric("bounds<-")) setGeneric("bounds<-",  function(object,value,...) standardGeneric('bounds<-'))
if (!isGeneric("catch<-"))  setGeneric("catch<-",   function(object,value,...) standardGeneric('catch<-'))
