setMethod("cpue<-", signature(object="aspic", value="data.frame"),
          function(object, value) object@cpue=value)
...
invisible(createFLAccesors("aspic", exclude=c("range","name","desc","obj","conditioning","options","diags","hessian",
                                              "stopmess","bounds","objFn","rnd")))
