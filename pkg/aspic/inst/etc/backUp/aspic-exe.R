...
setMethod('fit',    signature(object='aspic',cpue="data.frame"),
          function(object, cpue=cpue, package=attributes(class(object))$package, exeNm="aspic", dir=tempdir())
            runExe(object=object,cpue=cpue,package=package, exeNm=exeNm, dir=dir))

setMethod('fit',    signature(object='aspic',cpue="missing"),
          function(object, cpue=object@cpue, package=attributes(class(object))$package, exeNm="aspic", dir=tempdir())
            runExe(object=object,cpue=cpue,package=package, exeNm=exeNm, dir=dir))
