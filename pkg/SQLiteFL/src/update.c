 ...
 * Last Change: Tue Feb 21, 2012 at 10:36 AM +0100
 * $Id$
 *
 */
...
/* Function SEXP extendFLComp(SEXP Rdbname, SEXP Rname, SEXP Rflc, SEXP Rsnames, SEXP Rstring) {{{ */
SEXP extendFLComp(SEXP Rdbname, SEXP Rname, SEXP Rflc, SEXP Rsnames, SEXP Rstring)
  {
  SEXP Rval = R_NilValue;
  PROTECT(Rval = allocVector(INTSXP, 1));
  Rname = AS_CHARACTER(Rname);
