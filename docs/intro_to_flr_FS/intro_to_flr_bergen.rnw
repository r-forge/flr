...
\begin{frame}
  \frametitle{MSE - The Lego block approach}
   \begin{center}
      \includegraphics[width=1\textwidth]{/home/fas00/Work/Courses/Bergen/Presentation/MSE/MSE.png}
   \end{center}
\end{frame}
%************ Frame 9***********************
\begin{frame}
...
% Need to redo this figure
      \includegraphics[width=1\textwidth]{/home/fas00/Work/Courses/Bergen/Presentation/FLPackages/FLCore2.png}
   \end{center}
\end{frame}
%*********** Frame ***********************
\begin{frame}
...
%@ %def 
   \begin{center}
      \includegraphics[width=1\textwidth]{/home/fas00/Work/Courses/Bergen/Presentation/FLSR_plot.png}
   \end{center}
\end{frame}
